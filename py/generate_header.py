...
################################
def generate_struct(dbPath, headerFile, namespaces, version):
    ...
    with open(headerFile, 'w') as outFile:
        write_heading(outFile, headerFile, version)
...
def main():
    ...
    if target == "enum":
        ...
        generate_struct(dbPath, headerFile, namespaces, version)
    else:
        print_help(sys.argv[0])
        sys.exit()
