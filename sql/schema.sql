CREATE TABLE STAGING_DATA_MONSTER
(
	[TSR] VARCHAR(100) NULL,
	[Key] VARCHAR(100) NULL,
	[Setting] VARCHAR(100) NULL,
	[Main Title] VARCHAR(100) NULL,
	[Title] VARCHAR(100) NULL,
	[Name] VARCHAR(100) NULL,
	[Diet] VARCHAR(100) NULL,
	[Frequency] VARCHAR(100) NULL,
	[Hit Dice] VARCHAR(100) NULL,
	[Intelligence] VARCHAR(100) NULL,
	[Magic Resistance] VARCHAR(100) NULL,
	[Morale] VARCHAR(100) NULL,
	[Movement] VARCHAR(100) NULL,
	[No. Appearing] VARCHAR(100) NULL,
	[No. of Attacks] VARCHAR(100) NULL,
	[Organization] VARCHAR(100) NULL,
	[Size] VARCHAR(100) NULL,
	[Special Attacks] VARCHAR(100) NULL,
	[Special Defenses] VARCHAR(100) NULL,
	[THAC0] VARCHAR(100) NULL,
	[Treasure] VARCHAR(100) NULL,
	[XP Value] VARCHAR(100) NULL,
	[Alignment] VARCHAR(100) NULL,
	[Armor Class] VARCHAR(100) NULL,
	[Climate/Terrain] VARCHAR(100) NULL,
	[Damage/Attack] VARCHAR(100) NULL
);
...
(
	...
	[FOLLOWERS_RACE] INTEGER NULL,
	[CULT] INTEGER NOT NULL,
	FOREIGN KEY([REALM]) REFERENCES [REALM](ID),
	FOREIGN KEY([MORAL_ALIGNMENT]) REFERENCES [MORAL_ALIGNMENT](ID),
	FOREIGN KEY([RANK]) REFERENCES DEITY_RANK(ID)
	FOREIGN KEY([SEX]) REFERENCES SEX(ID)
	FOREIGN KEY([ACTIVITY]) REFERENCES DEITY_ACTIVITY(ID)
	FOREIGN KEY([CULT]) REFERENCES CULT(ID)
);
...
(
	...
	FOREIGN KEY([ADDITIONAL_NATURE]) REFERENCES [TREASURE_NATURE](ID)
);
...
CREATE TABLE ENCOUNTER_FREQUENCY
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[DESCRIPTION] VARCHAR(100) NOT NULL,
	[CHANCE] INT NULL
...
CREATE TABLE MANEUVERABILITY_CLASS
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[ACRONYM] CHAR(1) NULL,
	[DESCRIPTION] VARCHAR(100) NOT NULL
...
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[CAMPAIGN_SETTINGS_ID] INT NULL,
	[EXT_KEY] VARCHAR(20) NULL,
	[EXT_SUBKEY] VARCHAR(40) NULL,
	[NAME] VARCHAR(100) NOT NULL,
	[DISPLAY_NAME] VARCHAR(100) NULL,
	[FREQUENCY_ID] INT NULL,
	[INTELLIGENCE_FROM] INT NULL,
	[INTELLIGENCE_TO] INT NULL,
	FOREIGN KEY([CAMPAIGN_SETTINGS_ID]) REFERENCES [CAMPAIGN_SETTINGS](ID)
	FOREIGN KEY([FREQUENCY_ID]) REFERENCES [ENCOUNTER_FREQUENCY](ID)
);

CREATE TABLE MONSTER_CLIMATE_TERRAIN
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
...
CREATE TABLE MONSTER_ORGANISATION
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[MONSTER_ID] INTEGER NOT NULL,
...
CREATE TABLE MONSTER_ACTIVITY_CYCLE
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[MONSTER_ID] INTEGER NOT NULL,
	[ACTIVITY_CYCLE_ID] INT NULL,
	FOREIGN KEY([MONSTER_ID]) REFERENCES [MONSTER](ID),
	FOREIGN KEY([ACTIVITY_CYCLE_ID]) REFERENCES [ACTIVITY_CYCLE](ID)
);

CREATE TABLE MONSTER_DIET
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[MONSTER_ID] INTEGER NOT NULL,
	[DIET_ID] INT NULL,
...
CREATE TABLE MONSTER_ALIGNMENT
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[MONSTER_ID] INTEGER NOT NULL,
...
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[MONSTER_ID] INTEGER NOT NULL,
	[TREASURE_CLASS_ID] INT NULL,
	[MULTIPLIER] FLOAT NULL,
	[MULTIPLIER_DICE_NUM] INT NULL,
	[MULTIPLIER_DIE_FACES] INT NULL,
	[LOCATION_ID] INT NULL,
	[TREASURE_COMPONENT_ID] INT NULL,
	FOREIGN KEY([MONSTER_ID]) REFERENCES [MONSTER](ID),
	FOREIGN KEY([TREASURE_CLASS_ID]) REFERENCES [TREASURE_CLASS](ID),
	FOREIGN KEY([LOCATION_ID]) REFERENCES [TREASURE_LOCATION](ID),
	FOREIGN KEY([TREASURE_COMPONENT_ID]) REFERENCES [TREASURE_COMPONENT](ID)
);
...
(
	[MONSTER_ID] INTEGER NOT NULL PRIMARY KEY,
	[TYPE] INT NULL,
	FOREIGN KEY([TYPE]) REFERENCES [DRAGON_TYPE](ID)
);

CREATE TABLE MONSTER_APPEARING
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[MONSTER_ID] INTEGER NOT NULL,
	[NO_APPEARING_FROM] INTEGER NULL,
	[NO_APPEARING_TO] INTEGER NULL,
	[DICE_NUMBER] INTEGER NULL,
	[DIE_FACES] INTEGER NULL,
	[MODIFIER] INTEGER NULL,
	[MULTIPLIER] INTEGER NULL,
	[PROBABILITY] FLOAT NULL,
	[ENCOUNTER_LOCATION_ID] INTEGER NOT NULL DEFAULT(0),
	FOREIGN KEY([MONSTER_ID]) REFERENCES [MONSTER](ID),
	FOREIGN KEY([ENCOUNTER_LOCATION_ID]) REFERENCES [ENCOUNTER_LOCATION](ID)
);

CREATE TABLE MONSTER_AC
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[MONSTER_ID] INTEGER NOT NULL,
	[AC] INTEGER NULL,
	[AC_VARIANT] VARCHAR(50) NULL,
	FOREIGN KEY([MONSTER_ID]) REFERENCES [MONSTER](ID)
);

CREATE TABLE MONSTER_MOVEMENT
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[MONSTER_ID] INTEGER NOT NULL,
	[MOVEMENT_TYPE] INT NULL,
	[MOVEMENT_FACTOR] FLOAT NULL,
	[MANEUVERABILITY_CLASS] INT NULL,
	[MOVEMENT_VARIANT] VARCHAR(50) NULL,
	FOREIGN KEY([MONSTER_ID]) REFERENCES [MONSTER](ID),
	FOREIGN KEY([MOVEMENT_TYPE]) REFERENCES [MOVEMENT_TYPE](ID),
	FOREIGN KEY([MANEUVERABILITY_CLASS]) REFERENCES [MANEUVERABILITY_CLASS](ID)
);

CREATE TABLE MONSTER_VARIANT_TYPE
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[DESCRIPTION] VARCHAR(100) NOT NULL
);

CREATE TABLE MONSTER_VARIANT
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[MONSTER_ID] INTEGER NOT NULL,
	[MONSTER_VARIANT] VARCHAR(50) NULL,
	[HD] INTEGER NULL,
	[DIE_FACES] INTEGER NULL,
	[DIE_MODIFIER] INTEGER NULL,
	[HP] INTEGER NULL,
	[HP_TO] INTEGER NULL,
	[THAC0] INTEGER NULL,
...
(
	...
	[NAME] VARCHAR(100) NOT NULL,
	FOREIGN KEY(CAMPAIGN_ID) REFERENCES CAMPAIGN_SETTINGS(ID)
);
...
CREATE TABLE PLACE_OF_INTEREST_TYPE
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[DESCRIPTION] VARCHAR(100) NOT NULL
);
...
(
	...
	FOREIGN KEY(TYPE) REFERENCES PLACE_OF_INTEREST_TYPE(ID)
);

CREATE TABLE WEAPON_PROFICIENCY_LEVEL
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[DESCRIPTION] VARCHAR(100) NOT NULL
);

CREATE TABLE NON_WEAPON_PROFICIENCY_GROUP
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[NAME] VARCHAR(100) NOT NULL
);

CREATE TABLE NON_WEAPON_PROFICIENCY_GROUP_ACCESS
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[GROUP_ID] INTEGER NOT NULL,
	[CLASS_ID] INTEGER NOT NULL,
	FOREIGN KEY(GROUP_ID) REFERENCES NON_WEAPON_PROFICIENCY_GROUP(ID),
	FOREIGN KEY(CLASS_ID) REFERENCES CHARACTER_CLASS(ID)
);

CREATE TABLE NON_WEAPON_PROFICIENCY
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[NAME] VARCHAR(100) NOT NULL,
	[NUM_OF_SLOTS_REQUIRED] INT NOT NULL,
	[RELEVANT_ABILITY] INT NULL,
	[CHECK_MODIFIER] INT NOT NULL,
	FOREIGN KEY(RELEVANT_ABILITY) REFERENCES SKILL(ID)
);

CREATE TABLE NON_WEAPON_PROFICIENCY_GROUP_ASSOCIATION
(
	[ID] INTEGER NOT NULL PRIMARY KEY,
	[GROUP_ID] INTEGER NOT NULL,
	[PROFICIENCY_ID] INTEGER NOT NULL,
	FOREIGN KEY(GROUP_ID) REFERENCES NON_WEAPON_PROFICIENCY_GROUP(ID),
	FOREIGN KEY(PROFICIENCY_ID) REFERENCES NON_WEAPON_PROFICIENCY(ID)
);