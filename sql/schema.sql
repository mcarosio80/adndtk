...
(
	...
	[NO_APPEARING_FROM] INT NULL,
	[NO_APPEARING_TO] INT NULL,
	[ARMOR_CLASS] INT NULL,
	[MOVEMENT] INT NULL,
	[HIT_DICE] INT NULL,
	[THAC0] INT NULL,
	[NO_OF_ATTACKS] INT NULL,
	[DAMAGE_ATTACK_FROM] INT NULL,
	[DAMAGE_ATTACK_TO] INT NULL,
	[SPECIAL_ATTACKS] INT NULL,
	[SPECIAL_DEFENSES] INT NULL,
	[MAGIC_RESISTANCE] INT NULL,
	[SIZE] INT NULL,
	[MORALE_FROM] INT NULL,
	[MORALE_TO] INT NULL,
	[XP_VALUE] INT NULL,
