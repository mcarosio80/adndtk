...
TEST_CASE("[TC-STOR.009] Stores have a starting money availability between 1000 and 10000 CP", "[store]" )
{
    ...
    const uint32_t minAmt{OptionalRules::get_instance().get_option<uint32_t>(Option::store_min_cp_starting_amount)};
    const uint32_t maxAmt{OptionalRules::get_instance().get_option<uint32_t>(Option::store_max_cp_starting_amount)};
...
TEST_CASE("[TC-STOR.010] Stores have a starting money availability between 1000 and 5000 SP", "[store]" )
{
    ...
    const uint32_t minAmt{OptionalRules::get_instance().get_option<uint32_t>(Option::store_min_sp_starting_amount)};
    const uint32_t maxAmt{OptionalRules::get_instance().get_option<uint32_t>(Option::store_max_sp_starting_amount)};
    REQUIRE(s.check_availability(coinId, minAmt-1, true));
    REQUIRE_FALSE(s.check_availability(coinId, maxAmt+1, true));
...
TEST_CASE("[TC-STOR.011] Stores have a starting money availability between 1000 and 2000 EP", "[store]" )
{
    ...
    const uint32_t minAmt{OptionalRules::get_instance().get_option<uint32_t>(Option::store_min_ep_starting_amount)};
    const uint32_t maxAmt{OptionalRules::get_instance().get_option<uint32_t>(Option::store_max_ep_starting_amount)};
    REQUIRE(s.check_availability(coinId, minAmt-1, true));
    REQUIRE_FALSE(s.check_availability(coinId, maxAmt+1, true));
...
TEST_CASE("[TC-STOR.012] Stores have a starting money availability between 100 and 500 GP", "[store]" )
{
    ...
    const uint32_t minAmt{OptionalRules::get_instance().get_option<uint32_t>(Option::store_min_gp_starting_amount)};
    const uint32_t maxAmt{OptionalRules::get_instance().get_option<uint32_t>(Option::store_max_gp_starting_amount)};
    REQUIRE(s.check_availability(coinId, minAmt-1, true));
    REQUIRE_FALSE(s.check_availability(coinId, maxAmt+1, true));
...
TEST_CASE("[TC-STOR.013] Stores have a starting money availability between 100 and 200 PP", "[store]" )
{
    ...
    const uint32_t minAmt{OptionalRules::get_instance().get_option<uint32_t>(Option::store_min_pp_starting_amount)};
    const uint32_t maxAmt{OptionalRules::get_instance().get_option<uint32_t>(Option::store_max_pp_starting_amount)};
    REQUIRE(s.check_availability(coinId, minAmt-1, true));
    REQUIRE_FALSE(s.check_availability(coinId, maxAmt+1, true));
