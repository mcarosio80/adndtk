...
TEST_CASE("[TC-CHAR.035] Deities can be chosen according to the character's moral alignment", "[character]" )
{
    ...
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::tempus) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::selune) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::chauntea) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::mystryl) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::moradin) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::oghma) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::sune) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::cyric) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::corellon_larethian) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::shar) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::silvanus) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::gond) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::mask) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::mielikki) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::tymora) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::azuth) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::deneir) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::eldath) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::milil) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::bhaal) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::leira) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::waukeen) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::garagos) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::iyachtu_xvim) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::sharess) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::akadia) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::grumbar) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::ishtishia) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::kossuth) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::aerdrie_faenya) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::labelas_enoreth) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::berronar_truesilver) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::dugmaren_brightmantle) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::dumathoin) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::gorm_gulthyn) != deitiesTN.end());
    REQUIRE(std::find(deitiesTN.begin(), deitiesTN.end(), Defs::deity::haela_brightaxe) != deitiesTN.end());
    ...
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::tempus) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::lolth) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::mystryl) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::talos) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::cyric) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::corellon_larethian) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::shar) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::beshaba) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::gond) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::mask) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::umberlee) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::auril) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::deneir) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::eldath) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::malar) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::talona) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::bhaal) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::leira) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::myrkul) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::waukeen) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::garagos) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::iyachtu_xvim) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::shaundakul) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::akadia) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::fenmarel_mestarine) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::abbathor) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::berronar_truesilver) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::urdlen) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::shargaas) != deitiesCE.end());
    REQUIRE(std::find(deitiesCE.begin(), deitiesCE.end(), Defs::deity::yurtrus) != deitiesCE.end());
}
